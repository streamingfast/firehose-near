...
func (x *HeaderOnly) Reset() {
	*x = HeaderOnly{}
	mi := &file_sf_near_transform_v1_transform_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HeaderOnly) Descriptor() ([]byte, []int) {
	return file_sf_near_transform_v1_transform_proto_rawDescGZIP(), []int{2}
}

var File_sf_near_transform_v1_transform_proto protoreflect.FileDescriptor

const file_sf_near_transform_v1_transform_proto_rawDesc = "" +
	"\n" +
	"$sf/near/transform/v1/transform.proto\x12\x14sf.near.transform.v1\"\x8f\x01\n" +
	"\x12BasicReceiptFilter\x12\x1a\n" +
	"\baccounts\x18\x01 \x03(\tR\baccounts\x12]\n" +
	"\x17prefix_and_suffix_pairs\x18\x02 \x03(\v2&.sf.near.transform.v1.PrefixSuffixPairR\x14prefixAndSuffixPairs\"B\n" +
	"\x10PrefixSuffixPair\x12\x16\n" +
	"\x06prefix\x18\x01 \x01(\tR\x06prefix\x12\x16\n" +
	"\x06suffix\x18\x02 \x01(\tR\x06suffix\"\f\n" +
	"\n" +
	"HeaderOnlyBLZJgithub.com/streamingfast/firehose-near/pb/sf/near/transform/v1;pbtransformb\x06proto3"

var (
	file_sf_near_transform_v1_transform_proto_rawDescOnce sync.Once
	file_sf_near_transform_v1_transform_proto_rawDescData []byte
)
...
func file_sf_near_transform_v1_transform_proto_rawDescGZIP() []byte {
	file_sf_near_transform_v1_transform_proto_rawDescOnce.Do(func() {
		file_sf_near_transform_v1_transform_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sf_near_transform_v1_transform_proto_rawDesc), len(file_sf_near_transform_v1_transform_proto_rawDesc)))
	})
	return file_sf_near_transform_v1_transform_proto_rawDescData
}

var file_sf_near_transform_v1_transform_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_sf_near_transform_v1_transform_proto_goTypes = []any{
	...
	(*HeaderOnly)(nil),         // 2: sf.near.transform.v1.HeaderOnly
}
...
func file_sf_near_transform_v1_transform_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sf_near_transform_v1_transform_proto_rawDesc), len(file_sf_near_transform_v1_transform_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
